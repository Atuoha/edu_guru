...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFFA7C738);

  static const Color secondaryColor = Color(0xFF154266);

  static Color secondaryOpacity = const Color(0xFF154266).withOpacity(0.8);
